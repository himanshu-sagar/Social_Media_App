...
class Comment(models.Model):
    comment_by = models.ForeignKey(User, to_field="id", on_delete=models.CASCADE, related_name="comment_by")
    post = models.ForeignKey(Post, to_field="id", on_delete=models.CASCADE, related_name="commnet_on_post")
